=begin
    Harrisburg-Lancaster-Lebanon York County.rb is a Ruby file/crawler which Scraps the Offender Details from YORK County
    URL => "http://www.pameganslaw.state.pa.us/SearchResults.aspx?CountyName=YORK&amp;"!!!      
=end
...
STATE = "Harrisburg"				# State Is mentioned
COUNTY = "Lebanon York County"			# County Is mentioned
CITY = "Lancaster"					# City is mentioned
...
page=@agent.get("http://www.pameganslaw.state.pa.us/SearchResults.aspx?CountyName=YORK&amp;") rescue ""
...
page2=@agent.post("http://www.pameganslaw.state.pa.us/SearchResults.aspx?CountyName=YORK&amp%3b",next_page) rescue ""			# Posting the params
