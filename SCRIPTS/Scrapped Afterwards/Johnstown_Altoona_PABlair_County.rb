=begin
    Johnstown Altoona PA Blair County.rb is a Ruby file/crawler which Scraps the Offender Details from PA Blair County
    URL => "http://www.pameganslaw.state.pa.us/SearchResults.aspx?CountyName=BLAIR&amp;"!!!      
=end
...
STATE = "Johnstown"				# State Is mentioned
COUNTY = "PA Blair County"			# County Is mentioned
CITY = "Altoona"					# City is mentioned
...
page=@agent.get("http://www.pameganslaw.state.pa.us/SearchResults.aspx?CountyName=BLAIR&amp;") rescue ""
...
page2=@agent.post("http://www.pameganslaw.state.pa.us/SearchResults.aspx?CountyName=BLAIR&amp%3b",next_page) rescue ""			# Posting the params
