=begin
    Spartanburg County-Spartanburg.rb is a Ruby file/crawler which Scraps the Offender Details from South Carolina  County
...
DETAILEDURL="https://sword.doc.state.sc.us/scdc-public/inmateList.do;jsessionid=96A284526598BDBB8A34835107C86BF1"  # Passing Session Id To maintain Session
