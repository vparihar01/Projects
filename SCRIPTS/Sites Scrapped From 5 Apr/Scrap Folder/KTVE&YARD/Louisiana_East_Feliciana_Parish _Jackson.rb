=begin
     Louisiana East Feliciana Parish  County.rb is a Ruby file/crawler which Scraps the Offender Details from Louisiana East Feliciana Parish  County
    URL => "http://www.sheriffalerts.com/cap_main.php?office=54400"!!!      
=end
...
CITY = "Madison"
BASE="http://www.sheriffalerts.com/cap_main.php?office=54400" # Base URL to get the details 
...
for i in "a".."z"
	URL="http://www.icrimewatch.net/results.php?AgencyID=54400&SubmitNameSearch=1&OfndrLast=#{i}&OfndrFirst=&OfndrCity="
	doc=scrape.get(URL)
	...
	for j in 1..count
		PageUrl="http://www.icrimewatch.net/results.php?AgencyID=54400&SubmitNameSearch=1&OfndrCity=&OfndrLast=#{i}&OfndrFirst=&level=&AllCity=&excludeIncarcerated=0&page=#{j}" # Url for opening the Incarcated Offender's Page
